...
router.post('/', authMiddleware_1.authMiddleware, userController_1.addUser);
...
router.put('/:id/permissions', authMiddleware_1.authMiddleware, userController_1.updateUserPermissions);
